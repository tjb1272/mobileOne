...
function cloneRepo() {
    ...
    cmd.get(
        'rm -rf mobileOne && git clone https://github.com/tjb1272/mobileOne.git',
...
function transferProjectToRemote(failed, successful) {
    return ssh.putDirectory(__dirname + '/mobileOne', '/home/ubuntu/mobileOne-temp', {
        recursive: true,
        concurrency: 1,
...
function createRemoteTempFolder() {
    return ssh.execCommand('rm -rf mobileOne-temp && mkdir mobileOne-temp', { cwd: '/home/ubuntu' })
}
...
function updateRemoteApp() {
    return ssh.execCommand('cp -r mobileOne-temp/* mobileOne/ && rm -rf mobileOne-temp/*', { cwd: '/home/ubuntu' })
}
